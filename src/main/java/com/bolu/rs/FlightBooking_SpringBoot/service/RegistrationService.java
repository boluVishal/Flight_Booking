...
import com.bolu.rs.FlightBooking_SpringBoot.exception.UserIdAlreadyPresentException;
...
public class RegistrationService {
	...
	public void validateUser(User user)throws Exception
	{
		...
		//if(!isValidPassword(user.getPassword()))
			//sthrow new InvalidPasswordException("RegistrationService.INVALID_PASSWORD");
